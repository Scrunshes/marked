...
function mediaParser(provider, url) {
  ...
  if (provider === 'youtube') {
    ...
    if (vimeoMatch && vimeoMatch[1].length == 9) {
      return '<iframe src="//player.vimeo.com/video/' + vimeoMatch[1] + '" width="1280" height="720" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'
    } else {
      return undefined;
    }
  }
